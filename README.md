...
- Líder inicial: Freddy Ali Castro Román
- Responsable de evidencia: José Luis Islas Molina
- Responsable de calidad: Christopher Álvarez Centeno
- Integrante: José Eduardo Aguilar García
- Integrante: Daniel Buelna Andujo

No publiques matrículas, correos o teléfonos. Los roles rotan por unidad.

## Avances

- [Avance 1 (Unidad 1): análisis STRIDE, diagrama y controles](docs/avance-u1.md)
